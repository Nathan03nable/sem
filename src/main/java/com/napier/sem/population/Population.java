...
public class Population {
  ...
  public String topNPopulatedCountriesInWorld(String country, String limit) {
  ...
  public String topNPopulatedCountriesInContinent(String continent, String limit) {
    String stmt = String.format("SELECT name, code, continent, region, population, capital "
            + "FROM country "
            + "WHERE continent = '%s';"
            + "ORDER BY population "
  ...
  public String topNPopulatedCountriesInRegion(String region, String limit) {
    String stmt = String.format("SELECT name, code, continent, region, population, capital  "
            + "FROM country "
            + "WHERE region = '%s';"
            + "ORDER BY population "
